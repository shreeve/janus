...
5. **Cascade is explicit.**
   ...
   - **Site-scoped** (ping, cache, hub, auth, files, browse): global default → site
...
| Plane | Config | Role |
| --- | --- | --- |
| **data** | Site `janus` [block] | Admit this host into Janus; site-scoped overrides (ping, cache, hub, auth, files, browse) |
