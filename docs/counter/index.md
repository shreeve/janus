...
A guided tour of Janus v1.6.2 in one page and one `app.rip`. You will build
...
# (without a checkout, pin instead: xcaddy build --with github.com/shreeve/janus@v1.6.2 --output ./caddy)
```
