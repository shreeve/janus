...
routing, heartbeats, and TLS ask all have acceptance coverage.
...
| 1 | **ping** | Phase 1 |
| 2 | **control** | Phase 2 |
| 3 | **hub** | Phase 7 — shipped 2026-07-20: implementation landed with this commit against [`20260720-162350-hub-design.md`](20260720-162350-hub-design.md) |

Phase 3's apps registry is hot `/1.0` work, not a cold capability.
...
| --- | --- | --- |
| Process-wide | No — global `janus { }` only | **control**, **mdns** |
| Site-scoped | Yes — global default → site override | **ping**, **hub**, **auth**, **files**, **browse** |
...
deliberate follow-on work, not this SPEC's scope: the pending owner
policy call for a `docs/bench/` subfolder for raw bench files and the deferred
